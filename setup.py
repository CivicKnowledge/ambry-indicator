...
ps_meta = imp.load_source('_meta', 'ambry_indicator/__meta__.py')
...
setup(
    name='ambry-indicator',
    version=ps_meta.__version__,
    description='API Service for acessing classified Ambry bundles as indicators',
    ...
    scripts=['scripts/run-ambryind-gunicorn'],
    author=ps_meta.__author__,
    author_email=ps_meta.__author__,
    url='https://github.com/CivicKnowledge/ambry-indicator.git',
    license='BSD',
